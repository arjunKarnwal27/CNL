...
def process_straightened_files(initial_count, output_dir):
    processed_count = 0
    folder_path = 'venvName\straightenedfile'
...
def main():
    start = time.time()
    # USE 'RELATIVE PATH' for the following
    input_dir = 'venvName\svsfiles'  # Set this to the directory containing your SVS files
    output_dir = 'venvName\output'  # Set this to the desired output directory
    output_dir2 = 'venvName\output2'  # Set this to the desired output directory
    ...
    subprocess.call("TASKKILL /F /IM ImageJ-win64.exe") # kill fiji 
    end = time.time()
